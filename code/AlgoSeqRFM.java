 ...
 * Description: SeqRFM algorithm.
 */

public class AlgoSeqRFM {
...
//				System.out.println(node.getSequence() + "  #UTIL:" + utility + "  #SUP:" + support + "  #RECENCY:" + recency);
			...
			// call the SeqRFM function
			SeqRFM(node, revisedDataBase, minUtility, minsup);
	 ...
	 * @throws IOException
	 */
	private void SeqRFM(Node node, Map<Integer, List<List<UItem>>> revisedDataBase, double minUtil, double minsup)
			throws IOException {
...
//					System.out.println(n.getSequence() + "  #UTIL:" + utility + "  #SUP:" + support + "  #RECENCY:" + recency);
				...
				if (support >= minsup && recency >= minRecency) {
					...
					SeqRFM(n, revisedDataBase, minUtil, minsup);
				}
			}
...
//					System.out.println(n.getSequence() + "  #UTIL:" + utility + "  #SUP:" + support + "  #RECENCY:" + recency);
	...
	public PreLargeSet printStats() throws IOException {
		PreLargeSet res = new PreLargeSet();
		res.setTotalDbSize(totalSequence);
//		writer.write("===========  SeqRFM v4.0 ALGORITHM - STATS =========\n");
		System.out.println("===========  SeqRFM v4.0 ALGORITHM - STATS =========");
...
//		writer.write(" Total utility of DB: " + databaseUtility + "\n");
		...
		res.setTotalDbUtility(databaseUtility);
